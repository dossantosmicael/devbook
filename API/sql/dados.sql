...
values
("Publicação do Usuário 1", "Essa é a publicação do usuário 1! UHUL!", 1),
("Publicação do Usuário 2", "Essa é a publicação do usuário 2! UHUL!", 2),
("Publicação do Usuário 3", "Essa é a publicação do usuário 3! UHUL!", 3);